        ...
        <div class="col-12">
            ...
            <div class="card-header unselect">
                <span><i class="fa fa-wifi"></i>&nbsp; <b>Hotspot</b> &nbsp; </span>
                    <span class="card-tab" id="btn-hotspot-users"><i class="fa fa-users" ></i> Pengguna</span>
                    <span class="card-tab" onclick="loadUserProfiles()" id="btn-user-profiles"><i class="fa fa-pie-chart" ></i> Profile Pengguna</span>
                    <span class="card-tab" onclick="loadHotspotActive()" id="btn-hotspot-active"><i class="fa fa-wifi" ></i> Pengguna Aktif</span>
            ...
            <div class="row">
                <div class="col-12 hide" id="user-profiles">
                    ...
                    <div class="btn-group btn-container" >
                        <button class="bg-btn-group btn-add-hotspot-users" id=""><i class="fa fa-user-plus" ></i> Tambah User </button>
                        <button class="bg-btn-group btn-gen-hotspot-users" id=""><i class="fa fa-ticket" ></i> Buat </button>
                    </div>
                ...
                <div class="col-12 hide" id="hotspot-users">
                    ...
                    <div class="btn-group btn-container" >
                        <button class="bg-btn-group btn-add-hotspot-users" onclick="" ><i class="fa fa-user-plus" ></i> Tambahkan</button>
                        <button class="bg-btn-group btn-gen-hotspot-users" onclick="" ><i class="fa fa-ticket" ></i> Buat</button>
                    </div>
                    ...
                    <table class="table table-bordered table-hover hotspot-users">
                        <thead>
                            <tr>
                                ...
                                <th>Profil</th>
                                <th>Alamat MAC</th>
                                <th class="text-right">Waktu Aktif</th>
        ...
        <div class="mobile-card ">
            <div class="col-12 mr-b-10">
                ...
                <div class="dropdown">
                      ...
                      <div id="mDropdown" class="dropdown-content">
                        <a id="btn-hotspot-users"><i class="fa fa-users" ></i> Pengguna </a>
                        <a id="btn-user-profiles"><i class="fa fa-pie-chart" ></i> Profil Pengguna </a>
            ...
            <div class="row">
                <div class="col-12 hide" id="user-profiles">
                    ...
                    <div class="btn-group btn-container" >
                        <button class="btn-mobile bg-btn-group btn-add-hotspot-users" id=""><i class="fa fa-user-plus" ></i> Tambah Pengguna </button>
                        <button class="btn-mobile bg-btn-group btn-gen-hotspot-users" id=""><i class="fa fa-ticket" ></i> Buatkan </button>
                    </div>
                    <div id="btn-exp-mon" class="btn-group btn-container"> </div>
                    </div>
                    <div class="card-fixed mr-t-10">
                ...
                <div class="col-12 hide " id="hotspot-users">
                    ...
                    <div class="btn-group btn-container" >
                        <button class="btn-mobile bg-btn-group btn-add-hotspot-users" onclick="" ><i class="fa fa-user-plus" ></i> Tambah</button>
                        <button class="btn-mobile bg-btn-group btn-gen-hotspot-users" onclick="" ><i class="fa fa-ticket" ></i> Buatkan</button>
                    </div
...
<div id="addh_userprofile" class="modal unselect">
  <div class="modal-content<?=$modal_mobile;?>">
    ...
    <div class="modal-header<?=$modal_mobile;?>">
        ...
        <span id="usrproftt"><i class="fa fa-pie-chart"></i>&nbsp; <b>Tambahkan Profil</b> &nbsp; </span>
        <span class="card-tab card-tab-active" id="btn-upgeneral">Pengaturan</span>
    ...
    <div class="modal-body<?=$modal_mobile;?>">
        <div id="upgeneral">
            <table class="table">
              ...
              <tr><td>Alamat Pool</td><td>
                  <select class="form-control" id="add_addrpool">
                  <option value="none">none</option>
                  </select>
              </td></tr>
              <tr><td>Bagikan Pengguna</td><td><input id="add_sharedusr"  autocomplete="new-password" class="form-control" type="number" value="1"  min="0" max="999"/></td></tr>
              <tr id="trratelimit"><td>Limit Kecepatan <span id="hRateLimit" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td><input id="add_ratelimit" autocomplete="off" class="form-control" type="text" /></td></tr>
        ...
        <div id='updetails' class="hide">
            <table class="table">
        <tr id="trexpmode"><td >Mode Kadaluarsa <span id="hExpMode" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td>
                  <select class="form-control" id="add_expmode">
                    <option value="0">Tidak Ada</option>
                    <option value="rem">Hapus</option>
                    <option value="ntf">Pemberitahuan</option>
                    <option value="remc">Hapus & Pemberitahuan</option>
                    <option value="ntfc">Pemberitahuan & Rekam</option>
                  </select>
              </td></tr>
              ...
              <tr id="trlockuser"><td >Kunci Pengguna <span id="hLockUser" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td>
                  <select class="form-control" id="add_lockuser">
                    <option value="Disable">NonAktifkan</option>
                    <option value="Enable">Aktifkan</option>
                  </select>
              </td></tr>
              <tr id="trlockserver"><td >Kunci Sever <span id="hLockServer" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td>
  ...
  <div class="modal-content<?=$modal_mobile;?>">
    ...
    <div class="modal-header<?=$modal_mobile;?>">
      ...
      <!-- <h3 ><i class="fa fa-user-plus"></i> Add User</h3> -->
        ...
        <span id="usrtt"><i class="fa fa-user-plus"></i>&nbsp; <b>Tambahkan Pengguna</b> &nbsp; </span>
        <span class="card-tab card-tab-active" id="btn-general">Pengaturan</span>
    ...
    <div class="modal-body<?=$modal_mobile;?>">
        <div id="ugeneral">
            <table class="table">
              ...
              <tr><td>Nama</td><td><input id="add_usrid" autocomplete="off" class="form-control" type="hidden" value="0" /><input id="add_usrname" autocomplete="new-password" class="form-control" type="text" /></td></tr>
              ...
              <tr><td>Alamat MAC</td><td><input id="add_usrmac"  autocomplete="new-password" class="form-control" type="text" /></td></tr>
              <tr><td>Profil</td><td>
                  <select class="form-control" id="add_usrprofile">
                  </select>
              </td></tr>
              <tr><td>Limit Waktu <span id="hTimeLimit" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span></td><td><input id="add_tlimit" autocomplete="off" class="form-control" type="text" onkeyup="this.value = this.value.toLowerCase();" /></td></tr>
              <tr><td>Limit Data <span id="hDataLimit" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></td><td><input id="add_dlimit" autocomplete="off" class="form-control" type="text"  onkeyup="this.value = this.value.toUpperCase();" /></td></tr>
              <tr><td>Komentar</td><td><input id="add_usrcomm" autocomplete="off" class="form-control" type="text" /></td></tr>
              
          </table>
        </div>
        <div id='udetails' class="hide">
            <table class="table">
              <tr><td>Aktif Selama</td><td><input class="form-control" readonly type="text" id="uuptime" /></td></tr>
              ...
              <tr><td>Kode Pengguna</td><td><input class="form-control" readonly type="text" id="ucode" /></td></tr>
              <tr><td>Tanggal Kadaluarsa</td><td><input id="usrexp" autocomplete="off" class="form-control" type="text" readonly /></td></tr>
          </table>
        </div>
        <div>
            <table class="table">
                <tr>
                    <td>
                        <button class="btn bg-primary" style="float: right;" onclick="addUser()"><i class="fa fa-save"></i> Simpan</button>
                        <span id="usract-btn" style="display: none">
                            ...
                            <button class="btn bg-danger" style="float: right;" onclick="remUser()"><i class="fa fa-minus-square"></i> Hapus</button>
                        </span>
                    </td>
                </tr>
            </table>
  ...
  <div class="modal-content<?=$modal_mobile;?>">
    ...
    <div class="modal-header<?=$modal_mobile;?>">
      ...
      <!-- <h3 ><i class="fa fa-user-plus"></i> Add User</h3> -->
        ...
        <span id="gentt"><i class="fa fa-ticket"></i>&nbsp; <b>Buatkan</b> &nbsp; </span>
        <span class="card-tab card-tab-active" id="btn-gengeneral">Pengaturan</span>
    ...
    <div class="modal-body<?=$modal_mobile;?>">
        <div id="gengeneral">
            <table class="table">
            <tr><td>Jumlah</td><td><input id="gen_usrqty" autocomplete="off" class="form-control" type="number" value="1" min="1" max="500" /></td></tr>
              <tr><td>Server</td><td>
                  <select class="form-control" id="gen_hserver">
                    <option value="all">all</option>
                  </select>
              </td></tr>
              <tr><td>Mode Pengguna</td><td>
              ...
              <tr><td>Komentar</td><td><input id="gen_usrcomm" autocomplete="off" class="form-control" type="text" /></td></tr>
                </table>
        </div>
            <div id='gendetails' class="hide">
            <table class="table">            
              <tr><td>Limit Waktu<span id="ghTimeLimit" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span></td><td><input id="gen_tlimit" autocomplete="off" class="form-control" type="text" onkeyup="this.value = this.value.toLowerCase();" /></td></tr>
              <tr><td>Limit Data<span id="ghDataLimit" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></td><td><input id="gen_dlimit" autocomplete="off" class="form-control" type="text"  onkeyup="this.value = this.value.toUpperCase();" /></td></tr>
            </table>
            </div>
            <div>
            <table class="table">
