        ...
        <div class="col-4">
          <div class="box bmh-80 box-red">
            <div class="box-group">
                ...
                <div class="box-group-icon" style="height: 90px;"><i class="fa fa-wifi"></i><div>Pengguna Aktif</div></div>
            </div>
          ...
          <div class="col-4">
            <div class="box bmh-80 box-yellow">
              <div class="box-group">
                  ...
                  <div class="box-group-icon" style="height: 90px;"><i class="fa fa-users"></i><div>Pengguna</div></div>
              </div>
            </div>
          </div>
          <div class="col-4">
            <div class="box bmh-80 box-green">
              <div class="box-group">
                  ...
                  <div class="box-group-icon" ><i class="fa fa-money"></i><div>Penghasilan</div></div>
              </div>
            </div>
          </div>
      </div>
    ...
    <div class="col-8">
      <div class="row">
        <div class="col-6">
          <div class="card card-shadow">
            <div class="card-header">
              <h3><i class="fa fa-tasks"></i> Sumber <span id="identity"></span></h3>
            </div>
        ...
        <div class="col-12">
          <div class="card card-shadow">
            <div class="card-header">
              <h3><span ><i class="fa fa-area-chart"></i> Pemantau Jaringan </span>
            ...
            <div class="card-body card-body-rb">
              <div class="row">
                <div class="col-12">
                  <select id="iface-name" title="Pilih Jaringan"></select>
                </div>
                <div class="col-12">
    ...
    <div class="col-4">
      <div class="row">
          <div class="col-12">
            <div class="card card-shadow">
              <div class="card-header">
                <h3><i class="fa fa-file-text"></i> Riwayat Aplikasi</h3>
              </div>
              <div class="card-body card-body-rb">
          ...
          <div class="col-12">
            <div class="card card-shadow">
              <div class="card-header">
                <h3><i class="fa fa-file-text"></i> Riwayat Hotspot</h3>
              </div>
              <div class="card-body card-body-rb">
  ...
  <div class="mobile-body" >
        ...
        <div class="col-6">
          <div class="box bmh-60 box-red">
            <div class="box-group">
                ...
                <div class="box-group-icon" style="height: 60px;"><i class="fa fa-wifi"></i><div>Pengguna Aktif</div></div>
            </div>
          </div>
        </div>
          <div class="col-6">
            <div class="box bmh-60 box-yellow">
              <div class="box-group">
                  ...
                  <div class="box-group-icon" style="height: 60px;"><i class="fa fa-users"></i><div>Pengguna</div></div>
              </div>
            </div>
          </div>
          <div class="col-12">
    ...
    <div class="w-12" style="padding-bottom:100px;">
            ...
            <div class="mobile-card">
              <h3><i class="fa fa-server"></i> Info Sistem </h3>
            ...
            <div class="mobile-card">
              <h3><span><i class="fa fa-area-chart"></i> Pemantau Jaringan </span></h3>
              ...
              <div class="mobile-card" >
                <h3><i class="fa fa-file-text"></i> Riwayat Hostpot</h3>
